...
- Part 02 [38 Prefill/Decode Scheduling](../../02_PyTorch_Algorithms/38_Prefill_Decode_Scheduling.md)（长 prompt 影响并发时）
...
- Part 02 [35 Multi-Token Speculative Decoding](../../02_PyTorch_Algorithms/35_Multi_Token_Decoding.md)
...
- Part 02 [38 Prefill/Decode Scheduling](../../02_PyTorch_Algorithms/38_Prefill_Decode_Scheduling.md)
- Part 02 [39 Hetero PD and Serving Tiers](../../02_PyTorch_Algorithms/39_Hetero_PD_and_Serving_Tiers.md)
...
- **分布式机制与项目：** Part 02 [46 Communication Profiling with NCCL](../../02_PyTorch_Algorithms/46_Communication_Profiling_with_NCCL.md) → [48 Communication Hotspots and Mitigation](../../02_PyTorch_Algorithms/48_Communication_Hotspots_and_Mitigation.md) → [49 Parallelism Strategy Selection](../../02_PyTorch_Algorithms/49_Parallelism_Strategy_Selection.md) → [79 Distributed Parallel Benchmark](../../02_PyTorch_Algorithms/79_Distributed_Parallel_Benchmark.md) → [81 Distributed Inference Logic Validation](../../02_PyTorch_Algorithms/81_Distributed_Inference_Project.md)；MoE 分支进入 [47](../../02_PyTorch_Algorithms/47_MoE_Expert_Parallel.md) → [80](../../02_PyTorch_Algorithms/80_MoE_Expert_Parallel_Benchmark.md)
- **部署收口：** Part 02 [72 Multi-Model Deployment Comparison](../../02_PyTorch_Algorithms/72_Multi_Model_Deployment_Comparison.md)

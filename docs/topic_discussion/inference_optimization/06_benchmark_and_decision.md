...
完整的命令、运行开关、结果文件和 JSON schema 检查见[66–70 推理项目验证清单](../../verification/inference_projects.md)；本节只保留统一口径、项目分级和 `accept / tune / reject` 的判断规则。
...
完整启动和保存逻辑见 [66 Inference Performance Comparison](../../02_PyTorch_Algorithms/66_Inference_Performance_Comparison.md)。执行时按以下顺序保持口径一致：
...
- [68 Speculative Decoding Benchmark](../../02_PyTorch_Algorithms/68_Speculative_Decoding_Benchmark.md)
- [69 Prefix Caching Benchmark](../../02_PyTorch_Algorithms/69_Prefix_Caching_Benchmark.md)
- [70 Serving Scheduler Benchmark](../../02_PyTorch_Algorithms/70_Serving_Scheduler_Benchmark.md)

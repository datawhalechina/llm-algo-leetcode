    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '14. RLHF PPO Memory', link: '/02_PyTorch_Algorithms/14_RLHF_PPO_Memory' },
          { text: '15. DPO Loss Tutorial', link: '/02_PyTorch_Algorithms/15_DPO_Loss_Tutorial' },
          { text: '16. Attention 反向传播推导', link: '/02_PyTorch_Algorithms/16_Attention_Backward_Math' },
          { text: '17. FlashAttention Sim', link: '/02_PyTorch_Algorithms/17_FlashAttention_Sim' },
          { text: '19. Decoding Strategies', link: '/02_PyTorch_Algorithms/19_Decoding_Strategies' },
          { text: '21. vLLM PagedAttention', link: '/02_PyTorch_Algorithms/21_vLLM_PagedAttention' },
          { text: '23. SGLang RadixAttention', link: '/02_PyTorch_Algorithms/23_SGLang_RadixAttention' },
          { text: '25. Quantization W8A16', link: '/02_PyTorch_Algorithms/25_Quantization_W8A16' },
          { text: '26. Gradient Checkpointing', link: '/02_PyTorch_Algorithms/26_Gradient_Checkpointing' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '15. Triton Memory Model and Debug', link: '/03_CUDA_and_Triton_Kernels/15_Triton_Memory_Model_and_Debug' },
          { text: '17. Triton Llama3 Block Project', link: '/03_CUDA_and_Triton_Kernels/17_Triton_Llama3_Block_Project' },
          { text: '19. Triton Best Practices and FAQ', link: '/03_CUDA_and_Triton_Kernels/19_Triton_Best_Practices_and_FAQ' },
          { text: '21. PyTorch CUDA Streams and Transfer', link: '/03_CUDA_and_Triton_Kernels/21_PyTorch_CUDA_Streams_and_Transfer' },
          { text: '25. Distributed Communication Primitives', link: '/03_CUDA_and_Triton_Kernels/25_Distributed_Communication_Primitives' },
          { text: '26. DeepSpeed Zero Config', link: '/03_CUDA_and_Triton_Kernels/26_DeepSpeed_Zero_Config' },

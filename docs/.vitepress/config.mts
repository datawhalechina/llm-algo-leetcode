    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '13. RLHF PPO Memory', link: '/02_PyTorch_Algorithms/13_RLHF_PPO_Memory' },
          { text: '14. DPO Loss Tutorial', link: '/02_PyTorch_Algorithms/14_DPO_Loss_Tutorial' },
          { text: '15. Attention 反向传播推导', link: '/02_PyTorch_Algorithms/15_Attention_Backward_Math' },
          { text: '16. FlashAttention Sim', link: '/02_PyTorch_Algorithms/16_FlashAttention_Sim' },
          { text: '17. Decoding Strategies', link: '/02_PyTorch_Algorithms/17_Decoding_Strategies' },
          { text: '19. vLLM PagedAttention', link: '/02_PyTorch_Algorithms/19_vLLM_PagedAttention' },
          { text: '21. SGLang RadixAttention', link: '/02_PyTorch_Algorithms/21_SGLang_RadixAttention' },
          { text: '22. Quantization W8A16', link: '/02_PyTorch_Algorithms/22_Quantization_W8A16' },
          { text: '23. Gradient Checkpointing', link: '/02_PyTorch_Algorithms/23_Gradient_Checkpointing' },
          { text: '25. QLoRA and 4bit Quantization', link: '/02_PyTorch_Algorithms/25_QLoRA_and_4bit_Quantization' },
          { text: '26. ZeRO Optimizer Sim', link: '/02_PyTorch_Algorithms/26_ZeRO_Optimizer_Sim' },
          { text: '25. Tensor Parallelism Sim', link: '/02_PyTorch_Algorithms/25_Tensor_Parallelism_Sim' }
        ]
      },
      {
        ...
        items: [
          ...
          { text: '14. Triton Memory Model and Debug', link: '/03_CUDA_and_Triton_Kernels/14_Triton_Memory_Model_and_Debug' },
          { text: '16. Triton Llama3 Block Project', link: '/03_CUDA_and_Triton_Kernels/16_Triton_Llama3_Block_Project' },
          { text: '17. Triton Best Practices and FAQ', link: '/03_CUDA_and_Triton_Kernels/17_Triton_Best_Practices_and_FAQ' },
          { text: '19. PyTorch CUDA Streams and Transfer', link: '/03_CUDA_and_Triton_Kernels/19_PyTorch_CUDA_Streams_and_Transfer' },
          { text: '22. Distributed Communication Primitives', link: '/03_CUDA_and_Triton_Kernels/22_Distributed_Communication_Primitives' },
          { text: '23. DeepSpeed Zero Config', link: '/03_CUDA_and_Triton_Kernels/23_DeepSpeed_Zero_Config' },
          { text: '25. CUDA Custom Kernel Intro', link: '/03_CUDA_and_Triton_Kernels/25_CUDA_Custom_Kernel_Intro' },
          { text: '26. CUDA Shared Memory Optimization', link: '/03_CUDA_and_Triton_Kernels/26_CUDA_Shared_Memory_Optimization' },
          { text: '25. CUDA vs Triton vs PyTorch', link: '/03_CUDA_and_Triton_Kernels/25_CUDA_vs_Triton_vs_PyTorch' }
        ]
      }
    ],
    socialLinks: [
